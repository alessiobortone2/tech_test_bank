...
RSpec.describe TransactionLedgerDisplay do
  before(:each) do
    ...
    @transactionledgerdisplay = TransactionLedgerDisplay.new(@transactionledger.log)
  end

  it 'can print the header' do
    expect(@transactionledgerdisplay.print_header).to eq('date || credit || debit || balance')
  end
